OPENAI_MODELS = ["openai-gpt-3.5", "openai-gpt-4o", "openai-gpt-4o-mini", "openai_gpt_5_mini"]
...
CHAT_TOKEN_CUT_OFF = {
     ...
     ("openai-gpt-4","diffbot" ,'azure_ai_gpt_4o',"openai_gpt_4o", "openai_gpt_4o_mini", "openai_gpt_5_mini") : 28,
     ("ollama_llama3") : 2  
}  
